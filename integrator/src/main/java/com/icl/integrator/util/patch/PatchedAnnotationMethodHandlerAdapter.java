package com.icl.integrator.util.patch;
...
public class PatchedAnnotationMethodHandlerAdapter extends WebContentGenerator
	...
	private final Map<Class<?>, ServletHandlerMethodResolver>
			methodResolverCache =
	...
	public PatchedAnnotationMethodHandlerAdapter() {
	...
	public ModelAndView handle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		if (annotatedWithSessionAttributes == null) {
			annotatedWithSessionAttributes = (AnnotationUtils
					.findAnnotation(clazz, SessionAttributes.class) != null);
	 ...
	 * {@link org.springframework.web.bind.annotation.RequestMapping}-annotated method can calculate the lastModified value, call
	 ...
	 * @see org.springframework.web.bind.ServletRequestDataBinder#convertIfNecessary(Object, Class, org.springframework.core.MethodParameter)
	 */
	...
	/**
	 * Servlet-specific subclass of {@link org.springframework.web.bind.annotation.support.HandlerMethodResolver}.
	 */
	private class ServletHandlerMethodResolver extends HandlerMethodResolver {
		...
		public Method resolveHandlerMethod(HttpServletRequest request) throws
				ServletException {
			...
			if (!targetHandlerMethods.isEmpty()) {
				...
				if (!allowedMethods.isEmpty()) {
					throw new HttpRequestMethodNotSupportedException(request.getMethod(), StringUtils
		...
		private boolean useSuffixPattern(HttpServletRequest request) {
			Object value = request.getAttribute(USE_DEFAULT_SUFFIX_PATTERN);
			return (value != null) ? (Boolean) value : Boolean.TRUE;
		}
	...
	/**
	 * Servlet-specific subclass of {@link org.springframework.web.bind.annotation.support.HandlerMethodInvoker}.
	 */
	private class ServletHandlerMethodInvoker extends HandlerMethodInvoker {
		...
		protected WebDataBinder createBinder(NativeWebRequest webRequest, Object target, String objectName)
			...
			return PatchedAnnotationMethodHandlerAdapter.this.createBinder(
		...
		protected HttpInputMessage createHttpInputMessage(NativeWebRequest webRequest) throws Exception {
			...
			return PatchedAnnotationMethodHandlerAdapter.this.createHttpInputMessage(servletRequest);
		}

		@Override
		protected HttpOutputMessage createHttpOutputMessage(NativeWebRequest webRequest) throws Exception {
			HttpServletResponse servletResponse = (HttpServletResponse) webRequest.getNativeResponse();
			return PatchedAnnotationMethodHandlerAdapter.this.createHttpOutputMessage(servletResponse);
		}
	...
	static class RequestMappingInfo {
		...
		public boolean matchesHeaders(HttpServletRequest request) {
			return ServletAnnotationMappingUtils
					.checkHeaders(this.headers, request);
		}
	 ...
	 * <ul>
	 * <li>RHIs with {@linkplain PatchedAnnotationMethodHandlerAdapter.RequestSpecificMappingInfo#matchedPatterns better matched paths}
